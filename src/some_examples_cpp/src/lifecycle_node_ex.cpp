...
public:
  ...
  on_configure(const rclcpp_lifecycle::State &)
  {
    sub_ = create_subscription<std_msgs::msg::String>(
        "chatter", 10, std::bind(&MyLifecycleNode::msgCallback, this, _1));
...
int main(int argc, char * argv[])
{
  ...
  std::shared_ptr<MyLifecycleNode> simple_lifecycle_node =
    std::make_shared<MyLifecycleNode>("my_lifecycle_node");
