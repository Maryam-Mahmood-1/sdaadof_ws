...
def generate_launch_description():
    ...
    moveit_config = (MoveItConfigsBuilder("daadbot", package_name="daadbot_moveit")
                    .robot_description(file_path=os.path.join(get_package_share_directory("daadbot_desc"), "urdf/urdf_no_table", "daadbot.urdf.xacro"))
                    .robot_description_semantic(file_path="config/daadbot_no_table.srdf")
    ...
    rviz_config = os.path.join(get_package_share_directory("daadbot_moveit"), "config", "moveit2.rviz")
